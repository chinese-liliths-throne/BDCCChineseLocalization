...
- 2026.5.17
  - 发布 `v0.2.5-chs-1.1.0a` 版
    - 修复了部分漏译

- 2026.5.5
  - 发布 `v0.2.5-chs-1.0.0a` 版
    - 完成 `0.2.5` 版本的汉化

- 2026.3.1
  - 发布 `v0.1.12fix4-chs-1.2.0a` 版
    - 修复了部分漏译
    - 修复了身为奴隶时被解锁事件无法继续进行的问题

- 2025.12.15
  - 发布 `v0.1.12fix4-chs-1.1.0a` 版
    - 修复了性爱场景中的部分漏译

- 2025.12.12
  - 发布 `v0.1.12fix4-chs-1.0.0a` 版
    - 完成 `0.1.11fix4` 版本的汉化

- 2025.10.3
  - 发布 `v0.1.11fix1-chs-1.1.0a` 版
    - 修复了部分缺失的设置界面文本

- 2025.9.22
  - 发布 `v0.1.11fix1-chs-1.0.0a` 版
    - 完成 `0.1.11fix1` 版本的汉化
